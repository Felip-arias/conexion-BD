...
Partial Class Pedidos
    ...
    Private Sub InitializeComponent()
        ...
        ' MenuStrip1
        ' 
        MenuStrip1.Items.AddRange(New ToolStripItem() {InicioToolStripMenuItem, EmpleadosToolStripMenuItem, ClientesToolStripMenuItem, ProductosToolStripMenuItem, PagosToolStripMenuItem, SalirToolStripMenuItem})
